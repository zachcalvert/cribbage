...
def two_player_game_unstarted():
    return {"name": "cheers", "state": "INIT", "players": {"sam": 0, "diane": 0}}
...
def one_player_winning_game_dict():
    return {
        ...
        "state": "INIT",
        "type": "cribbage",
        "crib": ["04a70825ff", "276f33cf69", "9eba093a9d", "c88523b677"],
        "current_action": "play",
        "current_turn": "zach",
        "cut_card": "83ef982410",
        "cutter": "zach",
        ...
        "first_to_score": "zach",
        "hand_size": 6,
        "hands": {"zach": ["ace1293f8a"]},
        "jokers": False,
        "ok_with_next_round": [],
        "pegging": {
            "cards": ["fc0f324620", "fa0873dd7d", "60575e1068"],
            "passed": [],
            "run": [],
            "total": 19,
            "last_played": "zach",
        ...
        "play_again": [],
        "played_cards": {"zach": ["60575e1068", "fa0873dd7d", "fc0f324620"]},
        "post_deal_action": "discard",
        "previous_turn": {
            "action": "the four of clubs",
            "player": "zach",
            "points": 0,
            "reason": "",
        },
        "rematch": True,
        "scored_hands": [],
        "scoring_stats": {"zach": {"a_play": 0, "b_hand": 0, "c_crib": 0}},
        "winning_score": 12,
        "low_cut": "the ace of hearts",
        "opening_message": "the ace of hearts is the lowest cut, so zach deals first!",
        "winner": "zach",
    }
